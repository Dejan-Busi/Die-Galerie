...
import creationOfAdam from "../../Assets/Bilder/CreationOfAdam_horizontal.webp";
...
function CreationOfAdam() {
  ...
  const handlePost = async (event) => {
    ...
    try {
      const response = await api.post(`/api/kommentar/${5}`, kommentar, {
        headers: {
      ...
      <div className="portrait_Biographie">
        ...
        <div className="flexbox_vertikal">
          <p className="portraitParagraph">
            ...
            <br /> <br />
            Die Erschaffung Adams ist ein Fresko, das zwischen 1511 und 1512 in
            der Sixtinischen Kapelle in Rom gemalt wurde. Es zeigt die biblische
            Szene, in der Gott Adam das Leben gibt, indem er seinen Finger fast
            berührt. Die kraftvolle Komposition betont den Moment der göttlichen
            Schöpfung und die Verbindung zwischen Mensch und Gott. Michelangelo
            verwendet dabei eine harmonische Darstellung von Körper und Raum,
            die den menschlichen Körper idealisiert. Das Fresko ist eines der
            bekanntesten Werke der Renaissance und ein bedeutendes Symbol für
            den Menschheitsglauben und die göttliche Inspiration.
          </p>
        </div>
        <img
          src={creationOfAdam}
          alt="Die Erschaffung Adams"
