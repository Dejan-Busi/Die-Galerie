...
function TheKiss() {
  ...
  const handlePost = async (event) => {
    ...
    try {
      const response = await api.post(`/api/kommentar/${6}`, kommentar, {
        headers: {
  ...
  return (
    <section className="portrait_Page">
      <div className="portrait_Biographie">
        ...
        <h1 style={{ fontSize: "3.2rem", color: "white" }}>Der Kuss</h1>
        <div className="flexbox_Portrait">
          <img src={theKiss} alt="Der Kuss" className="portrait" />
          <div className="flexbox_vertikal">
            <p className="portraitParagraph">
              ...
              <br /> <br />
              Der Kuss wurde zwischen 1907 und 1908 gemalt und ist eines der
              ...
              Bild eine mystische und zeitlose Atmosphäre verleiht. Der Kuss
