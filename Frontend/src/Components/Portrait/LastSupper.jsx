...
import lastSupper from "../../Assets/Bilder/LastSupper_horizontal.webp";
...
function LastSupper() {
  ...
  const handlePost = async (event) => {
    ...
    try {
      const response = await api.post(`/api/kommentar/${3}`, kommentar, {
        headers: {
      ...
      <div className="portrait_Biographie">
        ...
        <div className="flexbox_vertikal">
          <p className="portraitParagraph">
            ...
            <br /> <br />
            Das letzte Abendmahl wurde zwischen 1495 und 1498 als Fresko in das
            Refektorium des Klosters Santa Maria delle Grazie in Mailand gemalt.
            Es zeigt die biblische Szene, in der Jesus mit seinen Jüngern das
            letzte Abendmahl feiert und ihnen ankündigt, dass einer von ihnen
            ihn verraten wird. Das Gemälde ist bekannt für die dramatische
            Komposition, die die Emotionen der Jünger und den Moment der
            Offenbarung einfängt. Leonardo verwendet perspektivische Techniken,
            um den Raum zu strukturieren und den Blick des Betrachters auf Jesus
            zu lenken. Das letzte Abendmahl gilt als eines der Meisterwerke der
            westlichen Kunstgeschichte und hat einen grossen Einfluss auf die
            Kunstwelt.
          </p>
        </div>
        <img
