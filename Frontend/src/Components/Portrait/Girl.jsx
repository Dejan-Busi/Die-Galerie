...
function Girl() {
  ...
  const handlePost = async (event) => {
    ...
    try {
      const response = await api.post(`/api/kommentar/${7}`, kommentar, {
        headers: {
  ...
  return (
    <section className="portrait_Page">
      <div className="portrait_Biographie">
        ...
        <h1 style={{ fontSize: "3.2rem", color: "white" }}>Das Mädchen</h1>
        <div className="flexbox_Portrait">
          <img src={girl} alt="Das Mädchen" className="portrait" />
          <div className="flexbox_vertikal">
            <p className="portraitParagraph">
              ...
              für seine intime, fast geheimnisvolle Atmosphäre bekannt, wobei
              das Mädchen den Betrachter mit einem sanften Blick ansieht. Die
