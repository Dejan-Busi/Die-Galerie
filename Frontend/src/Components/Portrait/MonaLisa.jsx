...
function MonaLisa() {
  ...
  const getKommentare = async () => {
    try {
      ...
      setNotAuthorized(error.respose.data);
    }
  };
  ...
  const handlePost = async (event) => {
    ...
    try {
      const response = await api.post(`/api/kommentar/${1}`, kommentar, {
        headers: {
  ...
  return (
    <section className="portrait_Page">
      <div className="portrait_Biographie">
        ...
        <h1 style={{ fontSize: "3.2rem", color: "white" }}>Mona Lisa</h1>
        <div className="flexbox_Portrait">
          <img src={monaLisa} alt="Mona Lisa" className="portrait" />
          <div className="flexbox_vertikal">
            <p className="portraitParagraph">
              ...
              <br /> <br />
              Die Mona Lisa ist eines der bekanntesten Gemälde der Welt. Es
              zeigt eine Frau mit einem geheimnisvollen Lächeln, das zu einem
              der berühmtesten Merkmale des Bildes geworden ist. Das Gemälde
              befindet sich im Louvre-Museum in Paris und wurde dort 1797
              ausgestellt. Die Identität der abgebildeten Frau ist nicht
              eindeutig geklärt, aber viele Historiker vermuten, dass es sich um
              Lisa Gherardini, die Frau des florentinischen Kaufmanns Francesco
              del Giocondo, handelt. Daher auch der Name La Gioconda im
              Italienischen. Die Mona Lisa ist bekannt für ihre innovative
              Verwendung von Licht und Schatten sowie für die sanften Übergänge
              zwischen den Gesichtszügen, was für die Zeit bahnbrechend war. Das
              Werk hat Generationen von Kunstexperten, Historikern und
              Bewunderern inspiriert und bleibt ein Meisterwerk der
