      ...
      <div id="signUpPage">
        ...
        <section id="startSeiteFlexbox">
          ...
          <div id="vorteile_Registrieren">
            <h2 style={{ color: "black" }}>Vorteile beim Registrieren:</h2>
          ...
          <div id="vorgeschmack_App">
            <h2 style={{ color: "black" }}>Ein Vorgeschmack der App:</h2>
            <NavLink
              to="/lobby"
              style={{ margin: "auto" }}
              onClick={handleMenuForward}
            >
              <p className="navLink" style={{ fontSize: "2.5rem" }}>
        ...
        >
          ...
          >
            <p className="navLink">Kontaktiere mich</p>
          </NavLink>
        </div>
      </div>
    </div>
